...
import {googleSpreadsheetInit, populateEmailStatusSheet, isNotificationSent} from '../helpers/spreadsheet.js';
    ...
    try {
        ...
        data.forEach(order => {
            sendEmailNotification({
                ...
                templateMessage: emailMarkup(order.customer_name, order.order_id, order.consignment_no),
            }, transporter)
                .then((result) => {
                    flag++;
